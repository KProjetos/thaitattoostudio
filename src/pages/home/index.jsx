...
function Home() {
  return (
    <main className="w-full direction-col-center p-0">
      ...
      <a aria-label="Whatsapp" target="_blank" className="fixed right-4 bottom-4" href="https://wa.me/5511940767201" onClick={ () => gtag('event', 'conversion', {'send_to': 'AW-11407376048/t4JZCL7t_4wZELD9ur8q'})}>
        <IconWhatsapp/>
      </a>
    </div>
    </main>

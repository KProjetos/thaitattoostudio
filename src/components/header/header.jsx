...
function Header() {
  ...
  return (
    <header className="w-full h-[85vh]  direction-col-center justify-start bg-principal z-50">
      ...
      <video className="w-full h-[85vh] mobile:absolute mobile:top-0 md:hidden object-fill z-0" autoPlay muted loop>
      ...
      <video className="hidden w-full h-[85vh] object-fill md:block  md:absolute md:top-0 md:z-0" autoPlay muted loop>

...
function AboutUs() {
  ...
  return (
    <section className="w-full direction-col-center bg-second">
          ...
          <div>
            <div>
              ...
              <div className="w-full direction-row justify-around absolute top-[2em] text-white ">
                <p className="py-2 px-4 bg-black/40 rounded-lg">Estilo</p>
                <p className=" py-2 px-4 bg-black/40 rounded-lg">Estilo</p>
                <p className=" py-2 px-4 bg-black/40 rounded-lg">Estilo</p>
              </div>
            </div>
      ...
      <div className="w-full direction-col-center  bg-principal text-white">
        <div className="w-[90%] max-w-[1080px] direction-col-center lg:direction-row gap-32">
        <div className="w-[50%] ">
        ...
        <div className="lg:w-[50%] direction-col items-start">
          <div className="">
            ...
            <p className="mt-4">
              ...
              profissionais capacitados. Utilizamos técnicas de relaxamento para
              tornar o processo de perfuração tranquilo e relaxante. Priorizamos
              sua comodidade e bem-estar durante todo o procedimento. Conte
              conosco para proporcionar uma experiência positiva e segura em
              cada etapa do seu caminho na arte corporal. Estamos aqui para
